...
const Footer = () => {
  return (
    <footer className="w-full h-[100px] flex items-center justify-evenly bg-gray-900">
        {/* footer Text */}
              <p className="text-white text-[17px] font-bold">Copyright &copy; {new Date().getFullYear()}. All right reserved</p>
               {/* Icons  */}
          <div>
            ...
            <a target="_blank" href="https://github.com/mrZaidDev">
              {" "}
              <i className="fab fa-github text-3xl text-white ml-2"></i>
            </a>
          </div>
    </footer>
  )
